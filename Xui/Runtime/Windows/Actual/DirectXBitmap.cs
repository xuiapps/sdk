...
/// </summary>
public sealed class DirectXBitmap : Xui.Core.Canvas.Bitmap, IDisposable
{
    ...
    public DirectXBitmap(D3D11.Texture2D? texture2D, D2D1.Bitmap1 d2d1Bitmap, uint width, uint height)
    {
